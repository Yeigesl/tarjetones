...
function validaValores(){
	if(document.frmUno.uno.value==''){
		alert('Introduzca algún número correspondiente a un tarjetón');
		document.frmUno.uno.focus();
		
	}else{
	if(document.frmUno.cad.value== ''||document.frmUno.cad.value<2019){
		
		alert('Introduzca una vigencia o una vigencia válida')
	...
	<table align="left" width="100%"  border="0" align="center">
		...
		<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12"></div>
		    ...
		    <div class="hovereffect">
		        	<img align="left" width="100%" height="211" class="img-responsive" src="web/images/slidemio.png" alt=""></img>
		       	 	<div class="overlay"></div>
		    </div>	
		 <tr>
   <td height="20" align="center" class="tituloServiciosExclusivos"><span class="style25">SISTEMA DE ESTACIONAMIENTO </span></td>
  </tr>
  <tr valign="top">
    <td>      
    ...
    <%//Presentación y botones %>
        ...
        <table     bgcolor="#FFFFFF" width="100%"  border="3" align="center" class="tituloServiciosExclusivos">
          <tr>
            <td><div align="center"><span class="style25">IMPRESI&Oacute;N DE  TARJETONES </span></div></td>
          </tr>
            </span></td>
        </table >
        <p>&nbsp;</p>
    ...
    <label class="botones" align="center">
      <input  id="boton1" type="radio" name="op1"   onclick="mostrar('tabla1',1,'tabla2','tabla3')" ondblclick="resetea()" checked>Por rango
    </label>
    <label class="radio-inline" align="center">
      <input id="boton2" type="radio" name="op1" onclick="mostrar('tabla2',2,'tabla1','tabla3')" ondblclick="reset()" unchecked>Imprimir todos
    </label>
     <label class="radio-inline" align="center">
      <input id="boton3" type="radio" name="op1" onclick="mostrar('tabla3',3,'tabla1','tabla2')" ondblclick="res()"unchecked>Imprimir un solo tarjet&oacute;n
    </label>
	</div>
          ...
          <tr class="style1">
            <td width="200"  bgcolor="#CCCCCC">
              <div align="left" class="style19">
                <div align="left" class="style24"><span class="style23">Rango Inicial </span>&nbsp;</div>
            </div></td>
            <td width="60"><input align="left" name="txtRini" type="text" id="txtRini" onkeypress="numeros()" size="15" maxlength="10" onblur="document.frmRegistro.txtUsuario.value = document.frmRegistro.txtUsuario.value.toUpperCase();document.frmRegistro.txtUsuario.value = document.frmRegistro.txtUsuario.value.trim();"/></td>
            <td width="200"  height="15" bgcolor="#CCCCCC">
            	<div align="left" class="style19">
                <div align="left" class="style24"><span class="style23">Rango Final </span>&nbsp;</div>
            </div></td>
            ...
            <td width="200"  height="15" bgcolor="#CCCCCC">
            	<div align="left" class="style19">
                <div align="left" class="style24"><span class="style23">Vigencia </span>&nbsp;</div>
            </div></td>
...
<form name="frm" method="post" action="prinTodos.jsp" action="tarjetones.java">
	<table id="tabla2"  style="visibility:hidden" width="47%" border="0" align="center" cellpadding="0" cellspacing="0">
			<tr class="style1">
            <td width="45"  height="15" bgcolor="#CCCCCC">
            	<div align="left" class="style19">
                <div align="left" class="style24"><span class="style23">Vigencia </span>&nbsp;</div>
            </div></td>
            <td width="60"><input name="vigente" type="text" id="vigente" onkeypress="numeros()" size="15" maxlength="10" onblur="document.frm.txtPassConfirm.value = document.frm.txtPassConfirm.value.toUpperCase();document.frm.txtUsuario.value = document.frm.txtUsuario.value.trim();" /></td>
            
            <td width="71"><span class="style12 style16"> </span>
    		<input align="left" type="button" name="bt"   value="Buscar" onclick="validaVigencia()"  />
		...
		<table id="tabla3"  style="visibility:hidden" width="70%" border="0" align="center" cellpadding="0" cellspacing="0">
			 <tr class="style1">
	            <td width="100"  height="15" bgcolor="#CCCCCC">
	            	<div align="left" class="style19">
	                <div align="left" class="style24"><span class="style23">N&uacute;mero de tarjet&oacute;n</span>&nbsp;</div>
	            </div></td>
	            ...
	            <td width="50"  height="15" bgcolor="#CCCCCC">
	            	<div align="left" class="style19">
	                <div align="left" class="style24"><span class="style23">Vigencia </span>&nbsp;</div>
	            </div></td>
	            <td width="45"><input name="cad" type="text" id="cad" onkeypress="numeros()" size="15" maxlength="10" onblur="document.frmUno.txtUsuario.value = document.frmUno.txtUsuario.value.toUpperCase();document.frmUno.txtUsuario.value = document.frmUno.txtUsuario.value.trim();" /></td>
	            
	            <td width="61"><span class="style12 style16"> </span>
	    		<input align="left" type="button" name="btBut"   value="Buscar" onclick="validaValores()"  />
