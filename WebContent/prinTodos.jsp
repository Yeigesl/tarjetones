...
<form name="frm" method="post" action=" ">
	<%//Impresion de todos los tarjetones %>
	<%String[][] resultado=ejecuta.getTodos();%>
          ...
          <tr>
            <td width="326" height="475"><table height="70%"  width="70%" border="0" align="center">
                ...
                <td  width="349" height="1"><table cellspacing="0" table-sm frame="void" rules="rows" width="70%"  height="%5" align="center">
                  <td colspan="2"><div align="center" class="style6"><span style="font-weight: bold; font-family: Arial, Helvetica, sans-serif;"> VIGENCIA <%=request.getParameter("vigente")%></span></div></td>
                </tr>
                <tr>
                  <td  width="349" height="1"><table cellspacing="0" table-sm frame="void" rules="cols" width="70%"  height="%5" align="center">
                  <%//String cadena=ejecuta.formateacadena(resultado[0][0]);%>
	...
	<td width="400"  bgcolor="#CCCCCC">
		<div class="aviso" align="center">
  			<strong>Aviso!</strong> No existen tarjetones, Gracias por su consulta.
		</div>         
     </td>	
	 <%}//ultimo else%>
</form>
