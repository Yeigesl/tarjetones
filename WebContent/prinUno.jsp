...
<body topmargin=1.27 leftmargin=7.11 marginheight=4.23 marginwidth=4.23  onLoad="imprime()">
	...
	<% int e=Integer.parseInt(request.getParameter("uno"));%>
    <%String[][] resultado=ejecuta.getUno(e);%>
          ...
          <tr>
            <td width="326" height="475"><table height="70%"  width="70%" border="0" align="center">
                ...
                <td  width="349" height="1"><table cellspacing="0" table-sm frame="void" rules="rows" width="70%"  height="%5" align="center">
                  <td colspan="2"><div align="center" class="style6"><span style="font-weight: bold; font-family: Arial, Helvetica, sans-serif;"> VIGENCIA <%=request.getParameter("cad")%></span></div></td>
                </tr>
                <tr>
                  <td  width="349" height="1"><table cellspacing="0" table-sm frame="void" rules="cols" width="70%"  height="%5" align="center">
                  <td width="50%"><div align="center" class="camposConsultas"><span style="font-family: Arial, Helvetica, sans-serif;font-weight: bold;font-size:11px"><strong><%out.print(ejecuta.formatea(resultado[0][0]));%></strong></span></div></td>
